        ...
        {if(metodo=="viveres"){
          ...
          return (
            <article
              ...
              <h3 className="text-base font-medium leading-[64px] break-words leading-normal max-w-[50%]">{item.producto}</h3>
          ...
          return (
            <article
              ...
              className="px-2 flex justify-between w-full h-16 text-veryDarkBlue mb-2 text-center border-2 shadow rounded-2xl"
            >
              <h3 className="text-base font-medium leading-[64px] break-words leading-normal max-w-[70%]">{item.producto}</h3>
              <p className="leading-[64px]">
